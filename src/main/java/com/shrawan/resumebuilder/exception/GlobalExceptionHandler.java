package com.shrawan.resumebuilder.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationException(MethodArgumentNotValidException ex){
        log.info("Inside the GlobalExceptionHandler - handleValidationException()");
    ...
    public ResponseEntity<Map<String, Object>> handleResourceExistsException(ResourceExistsException ex){
        log.info("Inside the GlobalExceptionHandler - handleResourceExistsException()");
        Map<String,Object> response = new HashMap<>();
